<nav class="nav">
  <ul>
   ...
   <li class="nav"><a href="testimonials.php">Testimonials</a></li>
   <li class="nav"><a href="curriculum.php">Curriculum</a></li>
   <li class="nav"><a href="family_tree.php">Family Tree</a></li>
