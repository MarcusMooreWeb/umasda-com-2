...
<html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <?php include 'nav.php' ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12" >
          <h2>What Curriculum do we teach?</h2>
          <p >Our coursework is modeled after the modern collegiate system, and is organized into four groups of courses designed to progressively increase in difficulty to match the student's growing skill set developed over time. Drawing on the experience of several of our lineage predecessors enables us to pull the best of each of the mother systems and include it in our Self Defense focused approach to learning. Most of our upline training history has included self defense as a component, whereas we are exclusively focused to that end. Our Coursework is comprised of selected techniques from American &amp; Chinese Kenpo systems, Aikijujitsu, Taiji, with basics that serve to drive comprehension and information retention.<br /></p>
          <h2>How do students access coursebooks?</h2>
