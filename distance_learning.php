...
<html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <?php include 'nav.php' ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12" >
          <h1>UMASDA Distance Learning Program</h1>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12" >
          ...
          <p> <br /></p>
          <p>UMASDA now has distance learning available!<br /></p>
          <p>Sometimes it isn’t possible to attend every class. In the past, this meant your progress might be slowed down as a result. Not any more!<br /></p>
          <p><br /></p>
